$(document).ready(function(){
    ...
    for (let i = 0; i < nizKomentara.length; i++) {
        ...
        if (komentar.korisnik ==korisnik ){
            ...
            $(".komentari").append('<li class="media"><div class="media-left"></div><div class="media-body "><h4 class="media-heading">Recept: '+naslov+'<br></h4><p>Komentar: '+komentar.tekst+'</p></div></li>');
        }
    ...
    for (let i = 0; i < nizOcena.length; i++) {
        ...
        if (komentar.korisnik ==korisnik ){
            ...
            $(".ocene").append('<li class="media"><div class="media-left"></div><div class="media-body "><h4 class="media-heading">Recept: '+naslov+'<br></h4><p>Ocena: '+komentar.ocena+'</p></div></li>');
        }
